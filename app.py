...
class Update():
    ...
    def Actualizar(self, table, asistencia, p1, p2, p3, p4, p5,cuaderno,id):
        cur = myqsl.connection.cursor()
        cur.execute(f"""
            UPDATE {table} SET 
...
def ActualizarCalificacion(id):
    if request.method == 'POST':
        ...
        Actualizado.Actualizar('RA1',asistencia_convertir,p1_convertir,p2_convertir,p3_convertir,p4_convertir,p5_convertir,cuaderno_convertir,id_co)
        return redirect(url_for('RA1'))
